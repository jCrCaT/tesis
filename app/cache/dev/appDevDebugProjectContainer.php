...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'addlocation' => 'getAddlocationService',
            ...
            'doctrine.dbal.datawarehouse_connection' => 'getDoctrine_Dbal_DatawarehouseConnectionService',
            'doctrine.dbal.default_connection' => 'getDoctrine_Dbal_DefaultConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.datawarehouse' => 'getDoctrine_Dbal_Logger_Profiling_DatawarehouseService',
            'doctrine.dbal.logger.profiling.default' => 'getDoctrine_Dbal_Logger_Profiling_DefaultService',
            'doctrine.orm.datawarehouse_entity_manager' => 'getDoctrine_Orm_DatawarehouseEntityManagerService',
            'doctrine.orm.datawarehouse_manager_configurator' => 'getDoctrine_Orm_DatawarehouseManagerConfiguratorService',
            ...
            'objetodw' => 'getObjetodwService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'registro' => 'getRegistroService',
    ...
    /**
     * Gets the 'addlocation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\AddLocation A App\MediBundle\Services\AddLocation instance.
     */
    protected function getAddlocationService()
    {
        return $this->services['addlocation'] = new \App\MediBundle\Services\AddLocation($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/mediApp/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/mediApp/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/mediApp/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/mediApp/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'comprobar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Comprobar A App\MediBundle\Services\Comprobar instance.
     */
    protected function getComprobarService()
    {
        return $this->services['comprobar'] = new \App\MediBundle\Services\Comprobar($this->get('doctrine.orm.default_entity_manager'), $this->get('listar'), $this->get('addlocation'));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'datawarehouse' => 'doctrine.dbal.datawarehouse_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'datawarehouse' => 'doctrine.orm.datawarehouse_entity_manager'), 'default', 'default');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.datawarehouse_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_DatawarehouseConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.datawarehouse'));
        ...
        return $this->services['doctrine.dbal.datawarehouse_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => '5432', 'dbname' => 'DW', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'doctrine.orm.datawarehouse_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DatawarehouseEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_datawarehouse_f119eee746fbe8d71aee1ca5e263a34e6e8d65bfd7fa2c49663101b80da88903');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_datawarehouse_f119eee746fbe8d71aee1ca5e263a34e6e8d65bfd7fa2c49663101b80da88903');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_datawarehouse_f119eee746fbe8d71aee1ca5e263a34e6e8d65bfd7fa2c49663101b80da88903');
        ...
        $f->setEntityNamespaces(array('DwBundle' => 'App\\DataWarehouseBundle\\Entity'));
        ...
        $this->services['doctrine.orm.datawarehouse_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.datawarehouse_connection'), $f);

        $this->get('doctrine.orm.datawarehouse_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.datawarehouse_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DatawarehouseManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.datawarehouse_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    /**
     * Gets the 'eliminar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Eliminar A App\MediBundle\Services\Eliminar instance.
     */
    protected function getEliminarService()
    {
        return $this->services['eliminar'] = new \App\MediBundle\Services\Eliminar($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Encoder A App\MediBundle\Services\Encoder instance.
     */
    protected function getEncoderService()
    {
        return $this->services['encoder'] = new \App\MediBundle\Services\Encoder($this->get('security.encoder_factory'));
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/mediApp/app/Resources');
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), '/var/www/mediApp/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'AppMediBundle' => 'App\\MediBundle\\AppMediBundle', 'KnpSnappyBundle' => 'Knp\\Bundle\\SnappyBundle\\KnpSnappyBundle', 'DwBundle' => 'App\\DataWarehouseBundle\\DwBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'AcmeDemoBundle' => 'Acme\\DemoBundle\\AcmeDemoBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    /**
     * Gets the 'grafico' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Grafico A App\MediBundle\Services\Grafico instance.
     */
    protected function getGraficoService()
    {
        return $this->services['grafico'] = new \App\MediBundle\Services\Grafico($this->get('doctrine.orm.default_entity_manager'), $this->get('listar'), $this->get('comprobar'), $this);
    }
    ...
    /**
     * Gets the 'listar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Listar A App\MediBundle\Services\Listar instance.
     */
    protected function getListarService()
    {
        return $this->services['listar'] = new \App\MediBundle\Services\Listar($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'modificar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Modificar A App\MediBundle\Services\Modificar instance.
     */
    protected function getModificarService()
    {
        return $this->services['modificar'] = new \App\MediBundle\Services\Modificar($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['monolog.handler.doctrine'] = new \Monolog\Handler\StreamHandler('/var/www/mediApp/app/logs/dev_doctrine.log', 100, true);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/mediApp/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'objetodw' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\EventListener\BuscarDw A App\MediBundle\EventListener\BuscarDw instance.
     */
    protected function getObjetodwService()
    {
        return $this->services['objetodw'] = new \App\MediBundle\EventListener\BuscarDw($this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('datawarehouse', $this->get('doctrine.dbal.logger.profiling.datawarehouse'));

        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/mediApp/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    /**
     * Gets the 'registro' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return App\MediBundle\Services\Registro A App\MediBundle\Services\Registro instance.
     */
    protected function getRegistroService()
    {
        return $this->services['registro'] = new \App\MediBundle\Services\Registro($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/mediApp/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/mediApp/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('App\\MediBundle\\Entity\\User1' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 15)), 'Symfony\\Component\\Security\\Core\\User\\User1' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 15))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginFirewallService()
    {
        ...
        return $this->services['security.firewall.map.context.login_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.main')), 'login_firewall', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $this->get('security.authentication.manager'), 'login_firewall', $c, $b), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5595ffef84026', $b), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login_firewall', $c, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $h, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $f, 'secured_area', $i, $b), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5595ffef84026', $b), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', $i, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/mediApp/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/mediApp/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/mediApp/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('pichi_22', array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/mediApp/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/mediApp/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/mediApp/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/mediApp/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/mediApp/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/mediApp/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/mediApp/src/App/MediBundle/Resources/views', 'AppMedi');
        $instance->addPath('/var/www/mediApp/src/App/DataWarehouseBundle/Resources/views', 'Dw');
        $instance->addPath('/var/www/mediApp/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/mediApp/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/mediApp/app/Resources/views');
        $instance->addPath('/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('04c39a830f62ab0f5a49f3cb25a7372dd8c8cbf3');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/mediApp/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/mediApp/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.datawarehouse' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_DatawarehouseService()
    {
        return $this->services['doctrine.dbal.logger.profiling.datawarehouse'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/empresa'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pais'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/region'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ciudad'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/comuna'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/area'), array(0 => 'ROLE_AREA'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/actividad'), array(0 => 'ROLE_PROFESIONAL'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard/proyecto'), array(0 => 'ROLE_FINANZA'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'secured_area', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5595ffef84026'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'login_firewall', $b, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5595ffef84026')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_FINANZA', 2 => 'ROLE_AREA', 3 => 'ROLE_JP', 4 => 'ROLE_PROFESIONAL'), 'ROLE_ADMIN' => array(0 => 'ROLE_AREA', 1 => 'ROLE_JP', 2 => 'ROLE_PROFESIONAL'), 'ROLE_AREA' => array(0 => 'ROLE_JP', 1 => 'ROLE_PROFESIONAL'), 'ROLE_FINANZA' => array(0 => 'ROLE_JP', 1 => 'ROLE_PROFESIONAL'), 'ROLE_JP' => array(0 => 'ROLE_PROFESIONAL')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'App\\MediBundle\\Entity\\User1', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/mediApp/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/mediApp/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/mediApp/app/cache/dev',
            'kernel.logs_dir' => '/var/www/mediApp/app/logs',
            'kernel.bundles' => array(
                ...
                'AppMediBundle' => 'App\\MediBundle\\AppMediBundle',
                'KnpSnappyBundle' => 'Knp\\Bundle\\SnappyBundle\\KnpSnappyBundle',
                'DwBundle' => 'App\\DataWarehouseBundle\\DwBundle',
            ...
            'locale' => 'en',
            'secret' => '04c39a830f62ab0f5a49f3cb25a7372dd8c8cbf3',
            ...
            'debug.container.dump' => '/var/www/mediApp/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '04c39a830f62ab0f5a49f3cb25a7372dd8c8cbf3',
            ...
            'session.save_path' => '/var/www/mediApp/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/mediApp/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/mediApp/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/mediApp/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/mediApp/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/mediApp/app/cache/dev/swiftmailer/spool/default',
            'swiftmailer.mailer.default.spool.enabled' => true,
            'swiftmailer.mailer.default.single_address' => 'pichi_22',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'pichi_22',
            ...
            'assetic.cache_dir' => '/var/www/mediApp/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/mediApp/app/../web',
            'assetic.write_to' => '/var/www/mediApp/app/../web',
            ...
            'doctrine.entity_managers' => array(
                ...
                'datawarehouse' => 'doctrine.orm.datawarehouse_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'datawarehouse' => 'doctrine.dbal.datawarehouse_connection',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/var/www/mediApp/app/cache/dev/doctrine/orm/Proxies',
