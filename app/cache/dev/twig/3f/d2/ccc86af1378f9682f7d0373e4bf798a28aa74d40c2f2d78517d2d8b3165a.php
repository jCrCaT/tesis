...
/* AppMediBundle:Default:tipoestudio.html.twig */
class __TwigTemplate_3fd2ccc86af1378f9682f7d0373e4bf798a28aa74d40c2f2d78517d2d8b3165a extends Twig_Template
{
...
<form action=\"";
        // line 14
        echo $this->env->getExtension('routing')->getPath("tipoestudio");
        echo "\" method=\"post\" ";
    ...
    ";
        ...
        if (((isset($context["tipo"]) ? $context["tipo"] : $this->getContext($context, "tipo")) == "crear")) {
            // line 16
            echo "    <h4>Agregar Tipo de estudio</h4>
    ";
        } else {
            // line 18
            echo "    <h4>Usted modificará el tipo de estudio <font class=\"red\">\"";
    ...
    ";
        ...
        echo "</td>
                <td>";
        // line 30
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "descripcion"), 'widget', array("value" => $this->getAttribute((isset($context["modificar"]) ? $context["modificar"] : $this->getContext($context, "modificar")), "nombre")));
        echo "</td>
                <td>";
        // line 31
...
";
    ...
    {
        return "AppMediBundle:Default:tipoestudio.html.twig";
    }
