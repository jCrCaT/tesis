...
/* AppMediBundle:Default:userarea.html.twig */
class __TwigTemplate_7ec7c8de894168c9eeead77dbf54046ac6498c1b6ae568cd7682fd28c294a0c4 extends Twig_Template
{
    ...
    ";
        ...
        if (((isset($context["tipo"]) ? $context["tipo"] : $this->getContext($context, "tipo")) == "crear")) {
            // line 5
            echo "    <h4>Asignar Área</h4>
    ";
        } else {
            // line 7
            echo "    <h4>Usted modificará el Área <font class=\"red\">\"\"</font> </h4>
    ";
        }
        // line 9
        ...
        echo "</td>
            ...
            <tr>
                <td>";
        // line 17
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "area"), 'label', array("label_attr" => array("class" => "etiqueta")));
        echo "</td>
                <td>";
        // line 18
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "area"), 'widget');
        echo "</td>
            </tr>
            ";
        // line 20
...
<table class=\"listar\">
        ...
        <tr>    
            ...
            <td class=\"tabInfo\">";
            // line 50
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["listar"]) ? $context["listar"] : $this->getContext($context, "listar")), "empleado"), "username"), "html", null, true);
            echo "</td>
            <td class=\"tabInfo\">";
            // line 51
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["listar"]) ? $context["listar"] : $this->getContext($context, "listar")), "area"), "nombre"), "html", null, true);
            echo "</td>
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["listar"]) ? $context["listar"] : $this->getContext($context, "listar")), "area"), "nombre"), "html", null, true);
            echo "\"></td>
            <td><input type=\"hidden\" name=\"empleado\" value=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["listar"]) ? $context["listar"] : $this->getContext($context, "listar")), "empleado"), "username"), "html", null, true);
            echo "\"></td>
...
";
    ...
    {
        return "AppMediBundle:Default:userarea.html.twig";
    }
