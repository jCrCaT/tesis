 ...
 */
class HitoLic extends \App\MediBundle\Entity\HitoLic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'descripcion', 'fecha', 'licitacion', 'tipo', 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HitoLic $proxy) {
