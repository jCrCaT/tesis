 ...
 */
class Empresa extends \App\MediBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rut', 'nombre', 'giro', 'direccion', 'correo', 'telefono', 'comuna');
        }
