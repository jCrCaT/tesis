 ...
 */
class ExcepcionProfesionalProyecto extends \App\MediBundle\Entity\ExcepcionProfesionalProyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fechaTermino', 'horas', 'proyecto', 'fechaIngreso', 'descripcion', 'fechaAnterior', 'accion', 'profesional');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExcepcionProfesionalProyecto $proxy) {
