 ...
 */
class Reunion extends \App\MediBundle\Entity\Reunion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fechaInicio', 'cliente', 'dependencia');
        }
    ...
    public function removeDependencia($profesional)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeDependencia', array($profesional));

        return parent::removeDependencia($profesional);
    }
