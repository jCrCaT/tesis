 ...
 */
class ExperienciaLaboral extends \App\MediBundle\Entity\ExperienciaLaboral implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'anoInicio', 'anoTermino', 'empresa', 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExperienciaLaboral $proxy) {
