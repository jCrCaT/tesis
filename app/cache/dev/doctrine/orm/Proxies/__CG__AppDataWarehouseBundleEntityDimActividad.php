 ...
 */
class DimActividad extends \App\DataWarehouseBundle\Entity\DimActividad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nombre', 'empresa', 'idActividad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DimActividad $proxy) {
