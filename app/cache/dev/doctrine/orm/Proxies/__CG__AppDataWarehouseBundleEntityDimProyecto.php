 ...
 */
class DimProyecto extends \App\DataWarehouseBundle\Entity\DimProyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nombre', 'empresa', 'fechainicio', 'fechatermino', 'horasprogramadas', 'cliente', 'estado', 'idProyecto');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DimProyecto $proxy) {
