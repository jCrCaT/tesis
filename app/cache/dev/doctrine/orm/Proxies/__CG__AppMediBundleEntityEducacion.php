 ...
 */
class Educacion extends \App\MediBundle\Entity\Educacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'anoInicio', 'anoTermino', 'institucion', 'carrera', 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Educacion $proxy) {
