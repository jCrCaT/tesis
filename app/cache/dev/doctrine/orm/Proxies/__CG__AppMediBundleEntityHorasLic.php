 ...
 */
class HorasLic extends \App\MediBundle\Entity\HorasLic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fechaInicio', 'fechaTermino', 'horaInicio', 'horaTermino', 'requerimiento', 'profesional', 'duracion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HorasLic $proxy) {
