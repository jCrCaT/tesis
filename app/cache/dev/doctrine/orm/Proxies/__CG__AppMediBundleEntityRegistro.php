 ...
 */
class Registro extends \App\MediBundle\Entity\Registro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'tipo', 'ipUsuario', 'datetime');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Registro $proxy) {
    ...
    public function setIpUsuario($ipUsuario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIpUsuario', array($ipUsuario));
    ...
    public function getIpUsuario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIpUsuario', array());
