 ...
 */
class EstadoProyecto extends \App\MediBundle\Entity\EstadoProyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstadoProyecto $proxy) {
