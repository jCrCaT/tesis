 ...
 */
class Hito extends \App\MediBundle\Entity\Hito implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fecha', 'nombre', 'descripcion', 'proyecto', 'tipo', 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Hito $proxy) {
