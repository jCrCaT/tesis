 ...
 */
class ExcepcionPlazoLicitacion extends \App\MediBundle\Entity\ExcepcionPlazoLicitacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fechaTermino', 'horas', 'licitacion', 'fechaIngreso', 'descripcion', 'fechaAnterior', 'profesional', 'accion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExcepcionPlazoLicitacion $proxy) {
