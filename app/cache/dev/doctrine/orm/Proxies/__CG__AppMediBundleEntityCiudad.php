 ...
 */
class Ciudad extends \App\MediBundle\Entity\Ciudad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'superior');
        }
    ...
    public function setSuperior($superior)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSuperior', array($superior));

        return parent::setSuperior($superior);
    }
