 ...
 */
class AuxAsignacionProyecto extends \App\DataWarehouseBundle\Entity\AuxAsignacionProyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'profesionalId', 'horas', 'proyectoId', 'valorHora', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AuxAsignacionProyecto $proxy) {
    ...
    public function setProyectoId($proyectoId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProyectoId', array($proyectoId));

        return parent::setProyectoId($proyectoId);
    }
