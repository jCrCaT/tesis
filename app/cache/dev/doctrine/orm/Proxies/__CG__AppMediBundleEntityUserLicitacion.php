 ...
 */
class UserLicitacion extends \App\MediBundle\Entity\UserLicitacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'horas', 'profesional', 'valorHora', 'licitacion', 'fechaInicio', 'fechaTermino');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserLicitacion $proxy) {
