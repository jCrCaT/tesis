 ...
 */
class ExcepcionPlazoProyecto extends \App\MediBundle\Entity\ExcepcionPlazoProyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExcepcionPlazoProyecto $proxy) {
