 ...
 */
class AsignacionEstado extends \App\MediBundle\Entity\AsignacionEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descripcion', 'fechaAsignacion', 'etapa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AsignacionEstado $proxy) {
